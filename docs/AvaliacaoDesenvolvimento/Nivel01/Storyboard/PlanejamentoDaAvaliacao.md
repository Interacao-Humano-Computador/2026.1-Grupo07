...
O objetivo desta avaliação é validar a **apropriação de tecnologia pelos usuários**, além de identificar possíveis **problemas de interação, fluxo e compreensão da interface** ainda na fase do modelo conceitual.  
...
3. As informações apresentadas nas telas/desenhos foram suficientes para entender as ações disponíveis?
4. Houve alguma etapa que pareceu desnecessária ou excessivamente complicada?
5. Você sentiu dificuldade para localizar funcionalidades ou informações importantes?
6. Os termos utilizados no Storyboard são claros e compreensíveis?
7. Existe alguma etapa que você faria de maneira diferente?
8. O fluxo apresentado transmite segurança e confiança para realizar a tarefa?
9. Você acredita que conseguiria concluir essa atividade sozinho utilizando o sistema?
10. Qual foi a principal dificuldade encontrada durante a visualização do Storyboard?
11. O que mais chamou sua atenção de forma positiva no fluxo apresentado?
12. Há alguma funcionalidade ou informação que você acredita estar faltando?
13. O Storyboard representa adequadamente suas necessidades e expectativas?
14. Você teria alguma sugestão para melhorar a experiência apresentada?
...
A entrevista será conduzida de forma semiestruturada, permitindo que os participantes expressem livremente suas opiniões, experiências e expectativas durante a análise do Storyboard. Dessa forma, asseguramos que a validação do artefato seja baseada em evidências reais do usuário.
...
Vale ressaltar que a **quantidade de storyboards avaliados será igual à quantidade de integrantes do grupo**. Além disso, garantimos a rastreabilidade do projeto: **cada Storyboard estará diretamente relacionado às tarefas previamente definidas na Análise de Tarefas**.
...
Durante as sessões, os integrantes poderão atuar individualmente ou em dupla:

* **Avaliador/Condutor:** Responsável por apresentar o Storyboard, orientar o participante e conduzir o roteiro da entrevista.
* **Anotador:** Responsável por registrar observações, dificuldades, comentários e comportamentos percebidos durante a sessão.
...
Antes da realização das entrevistas, os participantes deverão concordar com o Termo de Consentimento Livre e Esclarecido (TCLE).
...
Após a coleta dos dados, as informações serão analisadas com o objetivo de identificar:

- problemas de usabilidade;
- dificuldades de navegação e compreensão;
- quebras de expectativa;
- inconsistências no fluxo de tarefas;
- oportunidades de melhoria no modelo conceitual.

Os resultados serão organizados em um relatório padronizado contendo:

1. Os objetivos da avaliação;
2. A descrição do método utilizado;
3. O perfil e quantidade de participantes;
4. As tarefas avaliadas;
5. Os principais problemas encontrados;
6. A priorização dos problemas identificados;
7. As sugestões apresentadas pelos usuários;
8. A análise geral da experiência do usuário;
9. As recomendações para reprojeto do sistema.
