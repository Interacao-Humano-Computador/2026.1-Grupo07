...
| Logo | Nome | Finalidade |
| :---: | :---: | --- |
| ![alt text](image-1.png) | GitHub | Repositório utilizado para armazenar, organizar e versionar os artefatos produzidos no projeto. |
| ![alt text](image-4.png) | Visual Studio Code | Ambiente de desenvolvimento (IDE) utilizado para a criação do GitHub Pages e redação da documentação em Markdown. |

### Planejamento e Avaliação 

| Imagem | Nome | Finalidade |
| :---: | :---: | --- |
| ![alt text](image-6.png) | Livro: Interação Humano-Computador | **Base teórica principal:** BARBOSA, S. D. J. et al. Interação Humano-Computador e Experiência do Usuário. Rio de Janeiro: Autopublicação, 2021. |
| ![alt text](image-7.png) | Formulário de Avaliação Heurística | **Ferramenta de coleta:** Formulário padronizado do artigo *Avaliação Heurística de Sítios na Web* (Maciel et al.) para registrar contexto, causa, efeito e severidade das falhas. |
