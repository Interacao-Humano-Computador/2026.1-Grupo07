...
O uso de storyboards vai muito além da produção cinematográfica. De acordo com o <span class="hover-image">(StoryboardThat, 2023)<sup class="Print">[PRINT]</sup><img class= "img" src="../../assets/storyboard-pq.png" alt="Imagem 1"> </span>, eles são ferramentas indispensáveis para planejamento, visualização e comunicação. Eles servem para:
