...
| 2 | Philipe Amâncio | Presente | UNB - Engenharia de Software |
...
- Lista de sites avaliados → **Vitor e Thaiza**
- Site selecionado + explicação → **A definir**
- Ferramentas utilizadas → **Philipe**
**Processo de Design**
- Processo de design selecionado → **Maria**
- Cronograma detalhado → **Hugo**
**GitPages (Responsável: Ingrid)**
- Organização de todo o conteúdo no Git Pages
...
| 1 | Maria Laura Regis | Presente | UNB - Engenharia de Software |
| 2 | Philipe Amâncio | Presente | UNB - Engenharia de Software |
| 3 | Vitor Evangelista | Ausente | UNB - Engenharia de Software |
| 4 | Hugo | Presente | UNB - Engenharia de Software |
| 5 | Ingrid | Presente | UNB - Engenharia de Software |
...
| Nº | Descrição |
|----|------------|
| 1 | Aprofundamento da divisão de tarefas |
...
| Nº | Compromisso | Responsável | Data |
|----|--------------|-------------|------|
| 1 | Finalizar todas as demandas individuais | Equipe | Até 11/04/2026 |
...
- **Heatmap da disponibilidade dos membros:** Vitor
