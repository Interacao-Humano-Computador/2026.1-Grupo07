...
| :--- | :--- |
|**Foto**| ![alt text](image-28.png){width="600"}|
...
| **Identidade** | **Nome:** Márcia <br> **Idade:** 55 anos <br> **Sexo:** Feminino <br> **Localização:** Brasília, DF <br> **Status Socioeconômico:** Classe Média Alta <br> **Status na Pesquisa:** Persona Secundária |
...
| Categoria | Detalhes do Perfil |
| :--- | :--- |
|**Foto**| ![alt text](marina.webp){width="600"}|
